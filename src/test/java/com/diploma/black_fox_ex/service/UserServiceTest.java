...
class UserServiceTest {
    ...
    void updateUser() throws IOException {
        ...
        var dtoTrue = new UpdateUserDtoReq("Stanislav", "stas@mail.ru", "fdk1kj2kjJHF", "10",
                "big sex big sex big sex big sex big sex", multipartFile, "boy", "@StaseeX");

        var dtoUsernameErr = new UpdateUserDtoReq("S", "stas@mail.ru", "fdk1kj2kjJHF", "10",
                "big sex big sex big sex big sex big sex", multipartFile, "boy", "@StaseeX");

        var dtoEmailErr = new UpdateUserDtoReq("Stanislav", "stasail.ru", "fdk1kj2kjJHF", "10",
                "big sex big sex big sex big sex big sex", multipartFile, "boy", "@StaseeX");

        var dtoPassErr = new UpdateUserDtoReq("Stanislav", "stas@mail.ru", "1", "10",
                "big sex big sex big sex big sex big sex", multipartFile, "boy", "@StaseeX");
